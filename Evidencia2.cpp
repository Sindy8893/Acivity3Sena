//CATIVIDAD 3 EVIDENCIA 2 ESTRUCTURA SWITCH
...
int main()
{
    ...
    switch(costo)
    {
        case 30000:
        cout<<"TIPO: A"<<endl;
        porcentaje= ((precio-costo)/costo)*50;
        break;
        case 60000:
        cout<<"TIPO: B"<<endl;
        porcentaje= ((precio-costo)/costo)*40;
        break;
        case 100000:
        cout<<"TIPO: C"<<endl;
        porcentaje= ((precio-costo)/costo)*30;
        break;
        default: 
        cout<<"EL COSTO NO ESTA REGISTRADO"<<endl;
